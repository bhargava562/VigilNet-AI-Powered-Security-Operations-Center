...
class EndpointAgent:
    def __init__(self, alert_manager_instance, session_service: InMemorySessionService):
        ...
        self.adk_agent = Agent(
            ...
            instruction=(
                "You are an Endpoint Security Agent. Monitor endpoint events. "
                "Use `tool_detect_endpoint_anomaly`. If it returns an Anomaly object, act accordingly."
            ),
                    ...
                    if response_event.content and response_event.content.parts:
                        ...
                        if isinstance(anomaly, Anomaly):
                            ...
                            self.alert_manager.create_alert(
                                ...
                                anomalies=[anomaly],
                                suggested_actions=["Investigate the endpoint for root cause."]
                            )
